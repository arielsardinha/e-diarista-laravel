...
Route::put('/diaristas/{di}', [DiaristaController::class, 'update'])->name('diaristas.update');
Route::get('/diaristas/{di}', [DiaristaController::class, 'destroy'])->name('diaristas.destroy');